...
//        System.out.println("memberService.getClass() = " + memberService.getClass());
    ...
    @Test
    @DisplayName("구체 타입으로 조회") // 좋은 코드는 아니지만 언젠가 필요할 수 있음 (유연성이 떨어짐)
    ...
    @Test
    @DisplayName("빈 이름으로 조회 X") // 지정한 익셉션이 터져야 테스트 성공
    void findBeanByName_x(){
        assertThrows(NoSuchBeanDefinitionException.class, () ->
                ac.getBean("xxxxx", MemberService.class)); // 없는 빈 이름(xxxxx) 조회 시도
    }
}
